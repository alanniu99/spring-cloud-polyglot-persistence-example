...
public class Application {
	...
	public void postConstructConfiguration() {
		...
		// Register the ObjectMapper module for properly rendering HATEOAS REST
		// repositories
	...
	/**
	 * Bootstrap the Neo4j database with demo dataset. This can run multiple
	 * times without duplicating data.
	 *
	 * @param graphDatabaseConfiguration
	 *            is the graph database configuration to communicate with the
	 *            Neo4j server
	 * @return a {@link CommandLineRunner} instance with the method delegate to
	 *         execute
	 */
	@Bean
